  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        ["<C-f>"] = { ":silent !tmux neww ~/.dotfiles/tmx-sessionalize\n", desc = "New session tmux" }, -- change description but the same command
        -- copy all text in the file
        -- ["<Leader>ca"] = { ":%y<CR>", desc = "Copy all text" }, -- change description but the same command
        ["<Leader>rs"] = { ":LspOverloadsSignature<CR>", desc = "Show signature" },
